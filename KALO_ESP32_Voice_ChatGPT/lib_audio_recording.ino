...
#define GAIN_BOOSTER_I2S        64     // original I2S streams is VERY silent, so we added an optional GAIN booster for INMP441
...
#  define DEBUG false           // <- define your preference here  
...
bool Record_Start( String audio_filename ) 
{
  ...
  { 
    ...
    uint8_t audio_buffer_8bit[1024];    // 1024 values [1048 bytes] <- self calculated values in case BITS_PER_SAMPLE == 8
