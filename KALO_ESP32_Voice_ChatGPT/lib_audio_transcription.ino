...
// ----------------        [Release notes since July 2024: KeepAlive() commented out, progress '.' added]        ----------------   
// ------------------------------------------------------------------------------------------------------------------------------
...
#define STT_LANGUAGE  "en-US"   // # IMPORTANT Setting - update to YOUR spoken langguage ! #
                                // forcing single language: e.g. "de" (German), reason: improving recognition quality
...
#define STT_KEYWORDS            "&keywords=KALO&keywords=Google"   // optional, example, forcing STT to listen exactly
