...
int gl_CURR_FRIEND = 1;         // Current active FRIEND[n], DEFAULT user on Power On. <== globally used (BUTTON & REALTIME mode)
                                // Example 'gl_CURR_FRIEND = 1' -> let's start on Power ON with SUNNY
