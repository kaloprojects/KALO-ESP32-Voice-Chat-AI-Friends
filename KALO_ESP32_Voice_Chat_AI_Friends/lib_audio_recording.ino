...
/* --- DEBUG toggle needed, but already defined in main.ino tab:
...
/* --- HARDWARE settings needed (INMP441 microphone I2S pins & RECORD storage settings) -> moved to main.ino (PCB templates):
#define I2S_WS            xy     // 4 x I2S Audio input pins for microphone INMP441
#define I2S_SD            xy
#define I2S_SCK           xy
...
#define RECORD_SDCARD     false  // true: store Audio Recording .wav on SD card (prerequisite: SD card reader)
...
// [rx_handle]: global handle to the RX channel with channel configuration [std_cfg]
