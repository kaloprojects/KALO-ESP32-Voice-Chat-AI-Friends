...
// === HARDWARE seetings ======= // SELECT one of the pre-defined PCB - or use own INMP441 microfone I2S pin assignments ... 

/* --- PCB: KALO & TECHIESMS --- // KALO PCB and TECHIESMS PCB using same IS2 AUDIO IN pin assignments 
