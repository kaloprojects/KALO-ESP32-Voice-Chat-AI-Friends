...
- Currently thinking about a further version using PSRAM (instead SD card reader) for recording & transcription. This might reduce the STT transcription latency significantly. On review. Update (April 28, 2025): PSRAM working well (on my internal updates), but unfortunalty speed of SST not significantly improved, bottleneck seems an issue in WifiClientSecure.write. I will discuss my tests with Espressif ESP32 folks next. Ongoing.
