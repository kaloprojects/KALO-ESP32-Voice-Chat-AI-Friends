...
- RGB led: GREEN=Ready, RED=Recording, CYAN=STT, BLUE=OpenAI CHAT, PINK=Open AI WEB, YELLOW=Audio pending, PINK=Speaking. Short WHITE flashes after successfull STT & LLM response
