...
- STT: **ElevenLabs** or alternatively **Deepgram** API KEY needed, Registration info: [ElevenLabs](https://elevenlabs.io/de/pricing#pricing-table) (STT free 0$) / [Deepgram](https://console.deepgram.com/signup) 
