...
<br>
# Demo Videos
5 minute example chat. Using code default settings, System Prompt: Role of a 'good old friend'. Recorded video uses the older (slower) Deepgram SST, latest code update (using Elevenlabs SST) is answering significantly faster
